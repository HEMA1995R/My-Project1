...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">Kids clothing</p>
                <div class="list-group">
                     <a href="categoryDropdown/1" class="list-group-item">Polos & T-Shirts</a>
                    <a href="categoryDropdown/2" class="list-group-item">Shirts</a>
                    <a href="categoryDropdown/3" class="list-group-item">Jeans</a>
                    <a href="categoryDropdown/4" class="list-group-item">Ethnic Wear</a>
                    <a href="categoryDropdown/5" class="list-group-item">Dress & Skirts</a>
                </div>
            </div>
   <div class="col-md-9">
...
<a href="categoryback"><button type="button" class="btn btn-primary" >back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:8088/frontend/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8088/frontend/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8088/frontend/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8088/frontend/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
