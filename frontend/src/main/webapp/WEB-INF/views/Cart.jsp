...
<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="" height="77" width="77" style="font-family: monotype corsiva;" /><b>Kids Clothing</b></h1>
	</center>
...
<script>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.retrieveCart = function (cartId) 
     {
      ...
      {
         $http['delete']('http://localhost:8088/frontend/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     {
         $http.put('http://localhost:8088/frontend/usercart/cart/addItem/'+id).success(function (data) {
